...
public class PipeletFilterActor extends AbstractJavaClassActor
{
    private PipeletClassPredicate predicate = new PipeletClassPredicate();
    ...
    protected void receive(JavaClassRequest request)
    {
        ...
        {
            getSender().tell(new IsPipeletResponse(request, ResultType.TRUE.equals(result)), getSelf());
